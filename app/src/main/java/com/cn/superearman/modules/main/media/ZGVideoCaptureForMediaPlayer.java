package com.cn.superearman.modules.main.media;
...
import com.cn.superearman.modules.main.activity.ZAdminActivity;
...
/**
 * 外部采集工厂, 需要通过 {@link ZegoLiveRoom#()}设置到sdk
...
public class ZGVideoCaptureForMediaPlayer extends ZegoVideoCaptureFactory  {
     ...
     * 方便管理资源的生命周期
     */
    public static class ZGMediaPlayerVideoCapture extends ZegoVideoCaptureDevice  implements ZAdminActivity.playVideData{
        ...
        public ZGMediaPlayerVideoCapture(ZegoLiveRoom zegoLiveRoom) {
        ...
        protected void allocateAndStart(Client client) {
            ...
            mClient = client;
            mClient.setFillMode(ZegoVideoViewMode.ScaleAspectFit);
