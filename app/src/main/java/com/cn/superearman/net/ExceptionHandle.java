...
public class ExceptionHandle {
    ...
    public static RespondThrowable handleException(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            ex = new RespondThrowable(e, ERROR.HTTP_ERROR);
            ...
            ex = new RespondThrowable(e, ERROR.PARSE_ERROR);
            ex.message = "解析错误";
            return ex;
        } else if (e instanceof ConnectException) {
            ex = new RespondThrowable(e, ERROR.NET_WORD_ERROR);
            ex.message = "连接失败";
            return ex;
        } else if (e instanceof javax.net.ssl.SSLHandshakeException) {
            ex = new RespondThrowable(e, ERROR.SSL_ERROR);
            ex.message = "证书验证失败";
            return ex;
        } else {
            ex = new RespondThrowable(e, ERROR.UNKNOWN);
            ex.message = "未知错误";
            return ex;
        }
    }
    ...
    public static class RespondThrowable extends Exception {
        ...
        public RespondThrowable(Throwable throwable, int code) {
            super(throwable);
            this.code = code;
        }
    }
